...
cout << "-----modificaciones-----" << endl;
  ...
  cout << "El valor de la posicion para SP1 es:  " << result << endl;

  double result2 = sp2.QueValorEs(valor);
  cout << "El valor de la posicion para SP2 es:  " << result2 << endl;
  
  double result3 = sp3.QueValorEs(valor);
  cout << "El valor de la posicion para SP3 es:  " << result3 << endl;
